...
local hot_still = draw.load_image("Themes/"..hot.folder.."/textures/character.png")
local hot_animated = draw.load_image("Themes/"..hot.folder.."/textures/character_animated.gif")
