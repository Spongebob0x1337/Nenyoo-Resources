...
local THEME_NAME="2Take1"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\2Take1\\textures\\header.bmp"
local HEADER_PATH="Themes/2Take1/textures/header.bmp"
...
local FOOTER_FILE="Themes\\2Take1\\textures\\footer.bmp"
local FOOTER_PATH="Themes/2Take1/textures/footer.bmp"
...
local TOGGLE_ON_FILE="Themes\\2Take1\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/2Take1/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\2Take1\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/2Take1/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\2Take1\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/2Take1/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["list"]={file="Themes\\2Take1\\textures\\ui_theme_list.png",path="Themes/2Take1/textures/ui_theme_list.png",url=""},
    ["toggle off"]={file="Themes\\2Take1\\textures\\ui_theme_toggle_off.png",path="Themes/2Take1/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off list"]={file="Themes\\2Take1\\textures\\ui_theme_toggle_off_list.png",path="Themes/2Take1/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\2Take1\\textures\\ui_theme_toggle_on.png",path="Themes/2Take1/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on list"]={file="Themes\\2Take1\\textures\\ui_theme_toggle_on_list.png",path="Themes/2Take1/textures/ui_theme_toggle_on_list.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_2take1.ini"
menu.clear_settings()
...
menu.add_setting_slider("Stand Width",483,120,1200,1,"Width in Stand's 1920x1080 HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="width" then menu.set_setting("Stand Width",tonumber(value) or 483)
...
local function serialize_settings()
    ...
    local width=setting("Stand Width") or {f_val=483}
...
local function reset_settings()
    ...
    menu.set_setting("Stand Width",483)
...
function draw_menu()
    ...
    local source_width=clamp(width_setting and width_setting.f_val or 483,120,1200)
    ...
    local page_h=SUBHEADER_PATH~="" and native_height(subheader_handle,width,44*hud_sy)
        or (TABS_ENABLED and 44*hud_sy or 0)
