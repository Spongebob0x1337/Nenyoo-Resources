...
local THEME_NAME="Impulse"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=false
local HEADER_FILE="Themes\\Impulse\\textures\\header.gif"
local HEADER_PATH="Themes/Impulse/textures/header.gif"
...
local SUBHEADER_FILE="Themes\\Impulse\\textures\\subheader.bmp"
local SUBHEADER_PATH="Themes/Impulse/textures/subheader.bmp"
local SUBHEADER_URL_PATH=""
local subheader_handle=0
local subheader_downloaded=false
local FOOTER_FILE="Themes\\Impulse\\textures\\footer.bmp"
local FOOTER_PATH="Themes/Impulse/textures/footer.bmp"
...
local TOGGLE_ON_FILE="Themes\\Impulse\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Impulse/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Impulse\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Impulse/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Impulse\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Impulse/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["list"]={file="Themes\\Impulse\\textures\\ui_theme_list.png",path="Themes/Impulse/textures/ui_theme_list.png",url=""},
    ["toggle off"]={file="Themes\\Impulse\\textures\\ui_theme_toggle_off.png",path="Themes/Impulse/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off list"]={file="Themes\\Impulse\\textures\\ui_toggle_off_list.png",path="Themes/Impulse/textures/ui_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Impulse\\textures\\ui_theme_toggle_on.png",path="Themes/Impulse/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on list"]={file="Themes\\Impulse\\textures\\ui_toggle_on_list.png",path="Themes/Impulse/textures/ui_toggle_on_list.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_impulse.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",29,161,165,255,"Imported primary colour")
menu.add_setting_color("Stand Background",6,10,20,200,"Imported background colour")
...
menu.add_setting_slider("Stand Position X",80,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",200,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 80)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 200)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=29,g=161,b=165,a=255}
    local background=setting("Stand Background") or {r=6,g=10,b=20,a=200}
    ...
    local position_x=setting("Stand Position X") or {f_val=80}
    local position_y=setting("Stand Position Y") or {f_val=200}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",29,161,165,255)
    menu.set_setting("Stand Background",6,10,20,200)
    menu.set_setting("Stand Width",380)
    menu.set_setting("Stand Rows",15)
    menu.set_setting("Stand Row Height",33)
    menu.set_setting("Stand Position X",80)
    menu.set_setting("Stand Position Y",200)
...
function draw_menu()
    ...
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 80,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 200,0,1080)*hud_sy
