...
local NATIVE_CONFIG={
    classic={folder="LS TOKYO DRIFT",title="LS TOKYO DRIFT",subtitle="MIDNIGHT STREET NETWORK",effect="tokyo",file="ls_tokyo_drift_theme.ini",accent={245,105,28,255},secondary={45,205,255,255},bg={5,7,12,245},banner=true,banner_h=120},
