...
local THEME_NAME="Discord v2"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\Discord v2\\textures\\header.png"
local HEADER_PATH="Themes/Discord v2/textures/header.png"
...
local TOGGLE_ON_FILE="Themes\\Discord v2\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Discord v2/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Discord v2\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Discord v2/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Discord v2\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Discord v2/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\Discord v2\\textures\\ui_theme_disabled.png",path="Themes/Discord v2/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\Discord v2\\textures\\ui_theme_edit.png",path="Themes/Discord v2/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\Discord v2\\textures\\ui_theme_enabled.png",path="Themes/Discord v2/textures/ui_theme_enabled.png",url=""},
    ["friends"]={file="Themes\\Discord v2\\textures\\ui_theme_friends.png",path="Themes/Discord v2/textures/ui_theme_friends.png",url=""},
    ["game"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_game.png",path="Themes/Discord v2/textures/ui_theme_tabs_game.png",url=""},
    ["header loading"]={file="Themes\\Discord v2\\textures\\ui_theme_header_loading.png",path="Themes/Discord v2/textures/ui_theme_header_loading.png",url=""},
    ["link"]={file="Themes\\Discord v2\\textures\\ui_theme_link.png",path="Themes/Discord v2/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\Discord v2\\textures\\ui_theme_list.png",path="Themes/Discord v2/textures/ui_theme_list.png",url=""},
    ["online"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_online.png",path="Themes/Discord v2/textures/ui_theme_tabs_online.png",url=""},
    ["players"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_players.png",path="Themes/Discord v2/textures/ui_theme_tabs_players.png",url=""},
    ["search"]={file="Themes\\Discord v2\\textures\\ui_theme_search.png",path="Themes/Discord v2/textures/ui_theme_search.png",url=""},
    ["self"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_self.png",path="Themes/Discord v2/textures/ui_theme_tabs_self.png",url=""},
    ["stand"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_stand.png",path="Themes/Discord v2/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/game"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_game.png",path="Themes/Discord v2/textures/ui_theme_tabs_game.png",url=""},
    ["tabs/online"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_online.png",path="Themes/Discord v2/textures/ui_theme_tabs_online.png",url=""},
    ["tabs/players"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_players.png",path="Themes/Discord v2/textures/ui_theme_tabs_players.png",url=""},
    ["tabs/self"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_self.png",path="Themes/Discord v2/textures/ui_theme_tabs_self.png",url=""},
    ["tabs/stand"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_stand.png",path="Themes/Discord v2/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/vehicle"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Discord v2/textures/ui_theme_tabs_vehicle.png",url=""},
    ["tabs/world"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_world.png",path="Themes/Discord v2/textures/ui_theme_tabs_world.png",url=""},
    ["toggle off"]={file="Themes\\Discord v2\\textures\\ui_theme_toggle_off.png",path="Themes/Discord v2/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off auto"]={file="Themes\\Discord v2\\textures\\ui_theme_toggle_off_auto.png",path="Themes/Discord v2/textures/ui_theme_toggle_off_auto.png",url=""},
    ["toggle off list"]={file="Themes\\Discord v2\\textures\\ui_theme_toggle_off_list.png",path="Themes/Discord v2/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Discord v2\\textures\\ui_theme_toggle_on.png",path="Themes/Discord v2/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on auto"]={file="Themes\\Discord v2\\textures\\ui_theme_toggle_on_auto.png",path="Themes/Discord v2/textures/ui_theme_toggle_on_auto.png",url=""},
    ["toggle on list"]={file="Themes\\Discord v2\\textures\\ui_theme_toggle_on_list.png",path="Themes/Discord v2/textures/ui_theme_toggle_on_list.png",url=""},
    ["user"]={file="Themes\\Discord v2\\textures\\ui_theme_user.png",path="Themes/Discord v2/textures/ui_theme_user.png",url=""},
    ["users"]={file="Themes\\Discord v2\\textures\\ui_theme_users.png",path="Themes/Discord v2/textures/ui_theme_users.png",url=""},
    ["vehicle"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Discord v2/textures/ui_theme_tabs_vehicle.png",url=""},
    ["world"]={file="Themes\\Discord v2\\textures\\ui_theme_tabs_world.png",path="Themes/Discord v2/textures/ui_theme_tabs_world.png",url=""},
}
...
local function apply_font_scale(scale)
    ...
    text.set_size(font.title,math.max(1,22*scale))
...
local SETTINGS_FILE="stand_import_v3_discord_v2.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",71,88,239,255,"Imported primary colour")
menu.add_setting_color("Stand Background",88,101,242,175,"Imported background colour")
...
menu.add_setting_slider("Stand Position Y",210,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 210)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=71,g=88,b=239,a=255}
    local background=setting("Stand Background") or {r=88,g=101,b=242,a=175}
    ...
    local position_y=setting("Stand Position Y") or {f_val=210}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",71,88,239,255)
    menu.set_setting("Stand Background",88,101,242,175)
    ...
    menu.set_setting("Stand Position Y",210)
...
function draw_menu()
    ...
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 210,0,1080)*hud_sy
    local alpha=background.a or 175
    ...
    if 255>0 and 1>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,255,255,255,255,0,1)
    end
