...
text.set_font_for(font.tagline, "themes/Cherax Panel/fonts/moto-verse.ttf")
...
text.set_icon_font(font.label, "themes/Cherax Panel/fonts/FontAwesome.ttf")
...
-- ── Background images (themes/Cherax Panel/texture/) ──
local bg_names, bg_handles = {}, {}
local bg_dir = "themes/Cherax Panel/texture"
