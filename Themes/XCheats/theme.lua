...
local THEME_NAME="XCheats"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=false
local HEADER_FILE="Themes\\XCheats\\textures\\header.bmp"
local HEADER_PATH="Themes/XCheats/textures/header.bmp"
...
local SUBHEADER_FILE="Themes\\XCheats\\textures\\subheader.bmp"
local SUBHEADER_PATH="Themes/XCheats/textures/subheader.bmp"
local SUBHEADER_URL_PATH=""
local subheader_handle=0
local subheader_downloaded=false
local FOOTER_FILE="Themes\\XCheats\\textures\\footer.bmp"
local FOOTER_PATH="Themes/XCheats/textures/footer.bmp"
...
local TOGGLE_ON_FILE="Themes\\XCheats\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/XCheats/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\XCheats\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/XCheats/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\XCheats\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/XCheats/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["list"]={file="Themes\\XCheats\\textures\\ui_theme_list.png",path="Themes/XCheats/textures/ui_theme_list.png",url=""},
    ["toggle off"]={file="Themes\\XCheats\\textures\\ui_theme_toggle_off.png",path="Themes/XCheats/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off list"]={file="Themes\\XCheats\\textures\\ui_theme_toggle_off_list.png",path="Themes/XCheats/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\XCheats\\textures\\ui_theme_toggle_on.png",path="Themes/XCheats/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on list"]={file="Themes\\XCheats\\textures\\ui_theme_toggle_on_list.png",path="Themes/XCheats/textures/ui_theme_toggle_on_list.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_xcheats.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",109,112,114,255,"Imported primary colour")
menu.add_setting_color("Stand Background",0,0,0,225,"Imported background colour")
menu.add_setting_slider("Stand Width",365,120,1200,1,"Width in Stand's 1920x1080 HUD pixels")
menu.add_setting_slider("Stand Rows",12,5,24,1,"Visible option rows")
menu.add_setting_slider("Stand Row Height",36,12,100,1,"Row height in Stand HUD pixels")
menu.add_setting_slider("Stand Position X",1430,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",160,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="width" then menu.set_setting("Stand Width",tonumber(value) or 365)
        elseif key=="rows" then menu.set_setting("Stand Rows",tonumber(value) or 12)
        elseif key=="row_height" then menu.set_setting("Stand Row Height",tonumber(value) or 36)
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 1430)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 160)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=109,g=112,b=114,a=255}
    local background=setting("Stand Background") or {r=0,g=0,b=0,a=225}
    local width=setting("Stand Width") or {f_val=365}
    local rows=setting("Stand Rows") or {f_val=12}
    local row_height=setting("Stand Row Height") or {f_val=36}
    local position_x=setting("Stand Position X") or {f_val=1430}
    local position_y=setting("Stand Position Y") or {f_val=160}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",109,112,114,255)
    menu.set_setting("Stand Background",0,0,0,225)
    menu.set_setting("Stand Width",365)
    menu.set_setting("Stand Rows",12)
    menu.set_setting("Stand Row Height",36)
    menu.set_setting("Stand Position X",1430)
    menu.set_setting("Stand Position Y",160)
...
function draw_menu()
    ...
    local source_width=clamp(width_setting and width_setting.f_val or 365,120,1200)
    ...
    local row_h=clamp(row_height_setting and row_height_setting.f_val or 36,12,100)*hud_sy
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 1430,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 160,0,1080)*hud_sy
    local alpha=background.a or 225
