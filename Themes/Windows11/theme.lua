...
local BADGE_FILE="Themes\\Windows11\\textures\\badge.png"
local BADGE_PATH="Themes/Windows11/textures/badge.png"
local BADGE_URL_PATH=""
local BADGE_IS_LOGO=false
local badge_handle=0
local BACKGROUND_FILE="Themes\\Windows11\\textures\\background.png"
local BACKGROUND_PATH="Themes/Windows11/textures/background.png"
local BACKGROUND_URL_PATH=""
local background_handle=0
local background_downloaded=false
local TOGGLE_ON_FILE="Themes\\Windows11\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Windows11/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Windows11\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Windows11/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Windows11\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Windows11/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\Windows11\\textures\\ui_theme_disabled.png",path="Themes/Windows11/textures/ui_theme_disabled.png",url=""},
    ["enabled"]={file="Themes\\Windows11\\textures\\ui_theme_enabled.png",path="Themes/Windows11/textures/ui_theme_enabled.png",url=""},
    ["list"]={file="Themes\\Windows11\\textures\\ui_theme_list.png",path="Themes/Windows11/textures/ui_theme_list.png",url=""},
    ["toggle off"]={file="Themes\\Windows11\\textures\\ui_theme_toggle_off.png",path="Themes/Windows11/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off list"]={file="Themes\\Windows11\\textures\\ui_theme_toggle_off_list.png",path="Themes/Windows11/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Windows11\\textures\\ui_theme_toggle_on.png",path="Themes/Windows11/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on list"]={file="Themes\\Windows11\\textures\\ui_theme_toggle_on_list.png",path="Themes/Windows11/textures/ui_theme_toggle_on_list.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_windows11.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",255,255,255,255,"Imported primary colour")
menu.add_setting_color("Stand Background",0,0,0,0,"Imported background colour")
menu.add_setting_slider("Stand Width",480,120,1200,1,"Width in Stand's 1920x1080 HUD pixels")
...
menu.add_setting_slider("Stand Position X",1291,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",562,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="width" then menu.set_setting("Stand Width",tonumber(value) or 480)
        ...
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 1291)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 562)
        end
    end
end
...
local function serialize_settings()
    ...
    local background=setting("Stand Background") or {r=0,g=0,b=0,a=0}
    local width=setting("Stand Width") or {f_val=480}
    local rows=setting("Stand Rows") or {f_val=12}
    local row_height=setting("Stand Row Height") or {f_val=31}
    local position_x=setting("Stand Position X") or {f_val=1291}
    local position_y=setting("Stand Position Y") or {f_val=562}
    return table.concat({
...
local function reset_settings()
    ...
    menu.set_setting("Stand Background",0,0,0,0)
    menu.set_setting("Stand Width",480)
    menu.set_setting("Stand Rows",12)
    menu.set_setting("Stand Row Height",31)
    menu.set_setting("Stand Position X",1291)
    menu.set_setting("Stand Position Y",562)
...
function draw_menu()
    ...
    local source_width=clamp(width_setting and width_setting.f_val or 480,120,1200)
    ...
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 1291,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 562,0,1080)*hud_sy
    local alpha=background.a or 0
        ...
        if item then
            ...
            if item.is_header then
                ...
                text.draw_ellipsis(font.item,text_x,yy+(row_h-text.height(font.item))*0.5,
                    active and 0 or 0,active and 0 or 0,active and 0 or 0,active and 255 or 255,
                ...
                if toggle_type then
                    ...
                    if toggle_handle and toggle_handle>0 then
                        ...
                        draw.rect_outline(indicator_x-5,yy+row_h*0.5-5,indicator_x+5,yy+row_h*0.5+5,
                            active and 0 or 0,active and 0 or 0,active and 0 or 0,210,1,1)
                ...
                elseif action_mark then
                    ...
                    if action_handle and action_handle>0 then
                        ...
                        text.draw(font.small,x+width-10-text.width(font.small,mark),yy+(row_h-text.height(font.small))*0.5,
                            active and 0 or 0,active and 0 or 0,active and 0 or 0,255,mark)
                    end
                end
                if value~="" then
                    ...
                    text.draw(font.value,right-text.width(font.value,value),yy+(row_h-text.height(font.value))*0.5,
                        active and 0 or 0,active and 0 or 0,active and 0 or 0,255,value)
                end
            end
