...
local THEME_NAME="Trooper"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\Trooper\\textures\\header.png"
local HEADER_PATH="Themes/Trooper/textures/header.png"
...
local TOGGLE_ON_FILE="Themes\\Trooper\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Trooper/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Trooper\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Trooper/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Trooper\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Trooper/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\Trooper\\textures\\ui_theme_disabled.png",path="Themes/Trooper/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\Trooper\\textures\\ui_theme_edit.png",path="Themes/Trooper/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\Trooper\\textures\\ui_theme_enabled.png",path="Themes/Trooper/textures/ui_theme_enabled.png",url=""},
    ["friends"]={file="Themes\\Trooper\\textures\\ui_theme_friends.png",path="Themes/Trooper/textures/ui_theme_friends.png",url=""},
    ["game"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_game.png",path="Themes/Trooper/textures/ui_theme_tabs_game.png",url=""},
    ["link"]={file="Themes\\Trooper\\textures\\ui_theme_link.png",path="Themes/Trooper/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\Trooper\\textures\\ui_theme_list.png",path="Themes/Trooper/textures/ui_theme_list.png",url=""},
    ["online"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_online.png",path="Themes/Trooper/textures/ui_theme_tabs_online.png",url=""},
    ["players"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_players.png",path="Themes/Trooper/textures/ui_theme_tabs_players.png",url=""},
    ["search"]={file="Themes\\Trooper\\textures\\ui_theme_search.png",path="Themes/Trooper/textures/ui_theme_search.png",url=""},
    ["self"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_self.png",path="Themes/Trooper/textures/ui_theme_tabs_self.png",url=""},
    ["stand"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_stand.png",path="Themes/Trooper/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/game"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_game.png",path="Themes/Trooper/textures/ui_theme_tabs_game.png",url=""},
    ["tabs/online"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_online.png",path="Themes/Trooper/textures/ui_theme_tabs_online.png",url=""},
    ["tabs/players"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_players.png",path="Themes/Trooper/textures/ui_theme_tabs_players.png",url=""},
    ["tabs/self"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_self.png",path="Themes/Trooper/textures/ui_theme_tabs_self.png",url=""},
    ["tabs/stand"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_stand.png",path="Themes/Trooper/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/vehicle"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Trooper/textures/ui_theme_tabs_vehicle.png",url=""},
    ["tabs/world"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_world.png",path="Themes/Trooper/textures/ui_theme_tabs_world.png",url=""},
    ["toggle off"]={file="Themes\\Trooper\\textures\\ui_theme_toggle_off.png",path="Themes/Trooper/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off auto"]={file="Themes\\Trooper\\textures\\ui_theme_toggle_off_auto.png",path="Themes/Trooper/textures/ui_theme_toggle_off_auto.png",url=""},
    ["toggle off list"]={file="Themes\\Trooper\\textures\\ui_theme_toggle_off_list.png",path="Themes/Trooper/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Trooper\\textures\\ui_theme_toggle_on.png",path="Themes/Trooper/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on auto"]={file="Themes\\Trooper\\textures\\ui_theme_toggle_on_auto.png",path="Themes/Trooper/textures/ui_theme_toggle_on_auto.png",url=""},
    ["toggle on list"]={file="Themes\\Trooper\\textures\\ui_theme_toggle_on_list.png",path="Themes/Trooper/textures/ui_theme_toggle_on_list.png",url=""},
    ["user"]={file="Themes\\Trooper\\textures\\ui_theme_user.png",path="Themes/Trooper/textures/ui_theme_user.png",url=""},
    ["users"]={file="Themes\\Trooper\\textures\\ui_theme_users.png",path="Themes/Trooper/textures/ui_theme_users.png",url=""},
    ["vehicle"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Trooper/textures/ui_theme_tabs_vehicle.png",url=""},
    ["world"]={file="Themes\\Trooper\\textures\\ui_theme_tabs_world.png",path="Themes/Trooper/textures/ui_theme_tabs_world.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_trooper.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",33,33,37,255,"Imported primary colour")
menu.add_setting_color("Stand Background",40,40,45,250,"Imported background colour")
...
local function serialize_settings()
    local accent=setting("Stand Accent") or {r=33,g=33,b=37,a=255}
    local background=setting("Stand Background") or {r=40,g=40,b=45,a=250}
...
local function reset_settings()
    menu.set_setting("Stand Accent",33,33,37,255)
    menu.set_setting("Stand Background",40,40,45,250)
...
function draw_menu()
    ...
    if 255>0 and 3>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,0,0,0,255,0,3)
    end
    ...
    if page_h>0 then
        ...
        if TABS_ENABLED then
            ...
            text.draw(font.small,x+width-10-text.width(font.small,counter),
                page_y+(page_h-text.height(font.small))*0.5,191,191,189,255,counter)
        end
    end
        ...
        if item then
            ...
            if item.is_header then
                text.draw(font.small,x+10,yy+(row_h-text.height(font.small))*0.5,
                    active and 145 or accent.r,active and 63 or accent.g,active and 67 or accent.b,255,
                ...
                text.draw_ellipsis(font.item,text_x,yy+(row_h-text.height(font.item))*0.5,
                    active and 145 or 191,active and 63 or 191,active and 67 or 189,active and 255 or 255,
                ...
                if toggle_type then
                    ...
                    if toggle_handle and toggle_handle>0 then
                        ...
                        draw.rect_outline(indicator_x-5,yy+row_h*0.5-5,indicator_x+5,yy+row_h*0.5+5,
                            active and 145 or 191,active and 63 or 191,active and 67 or 189,210,1,1)
                        if item.on then draw.rect(indicator_x-3,yy+row_h*0.5-3,indicator_x+3,yy+row_h*0.5+3,
                            active and 145 or accent.r,active and 63 or accent.g,active and 67 or accent.b,255,1) end
                    end
                ...
                elseif action_mark then
                    ...
                    if action_handle and action_handle>0 then
                        ...
                        text.draw(font.small,x+width-10-text.width(font.small,mark),yy+(row_h-text.height(font.small))*0.5,
                            active and 145 or 191,active and 63 or 191,active and 67 or 189,255,mark)
                    end
                end
                if value~="" then
                    ...
                    text.draw(font.value,right-text.width(font.value,value),yy+(row_h-text.height(font.value))*0.5,
                        active and 145 or 191,active and 63 or 191,active and 67 or 189,255,value)
                end
            end
    ...
    if footer_handle and footer_handle>0 then
        ...
        text.draw(font.desc,x+9,desc_y+7,191,191,189,255,description,width-18)
        draw.pop_clip()
    end
