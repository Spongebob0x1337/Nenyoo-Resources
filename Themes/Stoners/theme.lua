...
local THEME_NAME="Stoners"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\Stoners\\textures\\header.gif"
local HEADER_PATH="Themes/Stoners/textures/header.gif"
...
local TOGGLE_ON_FILE="Themes\\Stoners\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Stoners/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Stoners\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Stoners/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Stoners\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Stoners/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\Stoners\\textures\\ui_theme_disabled.png",path="Themes/Stoners/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\Stoners\\textures\\ui_theme_edit.png",path="Themes/Stoners/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\Stoners\\textures\\ui_theme_enabled.png",path="Themes/Stoners/textures/ui_theme_enabled.png",url=""},
    ["friends"]={file="Themes\\Stoners\\textures\\ui_theme_friends.png",path="Themes/Stoners/textures/ui_theme_friends.png",url=""},
    ["header downloading"]={file="Themes\\Stoners\\textures\\ui_theme_header_downloading.png",path="Themes/Stoners/textures/ui_theme_header_downloading.png",url=""},
    ["header loading"]={file="Themes\\Stoners\\textures\\ui_theme_header_loading.png",path="Themes/Stoners/textures/ui_theme_header_loading.png",url=""},
    ["link"]={file="Themes\\Stoners\\textures\\ui_theme_link.png",path="Themes/Stoners/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\Stoners\\textures\\ui_theme_list.png",path="Themes/Stoners/textures/ui_theme_list.png",url=""},
    ["search"]={file="Themes\\Stoners\\textures\\ui_theme_search.png",path="Themes/Stoners/textures/ui_theme_search.png",url=""},
    ["toggle off"]={file="Themes\\Stoners\\textures\\ui_theme_toggle_off.png",path="Themes/Stoners/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off auto"]={file="Themes\\Stoners\\textures\\ui_theme_toggle_off_auto.png",path="Themes/Stoners/textures/ui_theme_toggle_off_auto.png",url=""},
    ["toggle off list"]={file="Themes\\Stoners\\textures\\ui_theme_toggle_off_list.png",path="Themes/Stoners/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Stoners\\textures\\ui_theme_toggle_on.png",path="Themes/Stoners/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on auto"]={file="Themes\\Stoners\\textures\\ui_theme_toggle_on_auto.png",path="Themes/Stoners/textures/ui_theme_toggle_on_auto.png",url=""},
    ["toggle on list"]={file="Themes\\Stoners\\textures\\ui_theme_toggle_on_list.png",path="Themes/Stoners/textures/ui_theme_toggle_on_list.png",url=""},
    ["user"]={file="Themes\\Stoners\\textures\\ui_theme_user.png",path="Themes/Stoners/textures/ui_theme_user.png",url=""},
    ["users"]={file="Themes\\Stoners\\textures\\ui_theme_users.png",path="Themes/Stoners/textures/ui_theme_users.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_stoners.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",168,230,163,255,"Imported primary colour")
menu.add_setting_color("Stand Background",99,154,82,255,"Imported background colour")
menu.add_setting_slider("Stand Width",406,120,1200,1,"Width in Stand's 1920x1080 HUD pixels")
...
menu.add_setting_slider("Stand Position X",1490,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",635,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="width" then menu.set_setting("Stand Width",tonumber(value) or 406)
        ...
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 1490)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 635)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=168,g=230,b=163,a=255}
    local background=setting("Stand Background") or {r=99,g=154,b=82,a=255}
    local width=setting("Stand Width") or {f_val=406}
    local rows=setting("Stand Rows") or {f_val=12}
    local row_height=setting("Stand Row Height") or {f_val=31}
    local position_x=setting("Stand Position X") or {f_val=1490}
    local position_y=setting("Stand Position Y") or {f_val=635}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",168,230,163,255)
    menu.set_setting("Stand Background",99,154,82,255)
    menu.set_setting("Stand Width",406)
    menu.set_setting("Stand Rows",12)
    menu.set_setting("Stand Row Height",31)
    menu.set_setting("Stand Position X",1490)
    menu.set_setting("Stand Position Y",635)
...
function draw_menu()
    ...
    local source_width=clamp(width_setting and width_setting.f_val or 406,120,1200)
    ...
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 1490,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 635,0,1080)*hud_sy
    ...
    if 255>0 and 1>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,61,122,42,255,5,1)
    end
    ...
    if page_h>0 then
        ...
        if TABS_ENABLED then
            ...
            text.draw(font.small,x+width-10-text.width(font.small,counter),
                page_y+(page_h-text.height(font.small))*0.5,255,255,255,200,counter)
        end
    end
    ...
    for row=0,visible-1 do
        ...
        if item then
            ...
            if 255>0 then
                draw.rect(x,yy+row_h-1,x+width,yy+row_h,61,122,42,math.min(255,80))
            end
            ...
            if item.is_header then
                ...
                text.draw_ellipsis(font.item,text_x,yy+(row_h-text.height(font.item))*0.5,
                    active and 0 or 255,active and 0 or 255,active and 0 or 255,active and 255 or 200,
                ...
                if toggle_type then
                    ...
                    if toggle_handle and toggle_handle>0 then
                        ...
                        draw.rect_outline(indicator_x-5,yy+row_h*0.5-5,indicator_x+5,yy+row_h*0.5+5,
                            active and 0 or 255,active and 0 or 255,active and 0 or 255,210,1,1)
                ...
                elseif action_mark then
                    ...
                    if action_handle and action_handle>0 then
                        ...
                        text.draw(font.small,x+width-10-text.width(font.small,mark),yy+(row_h-text.height(font.small))*0.5,
                            active and 0 or 255,active and 0 or 255,active and 0 or 255,255,mark)
                    end
                end
                if value~="" then
                    ...
                    text.draw(font.value,right-text.width(font.value,value),yy+(row_h-text.height(font.value))*0.5,
                        active and 0 or 255,active and 0 or 255,active and 0 or 255,255,value)
                end
            end
    ...
    if footer_handle and footer_handle>0 then
        ...
        text.draw(font.desc,x+9,desc_y+7,255,255,255,200,description,width-18)
        draw.pop_clip()
    end
