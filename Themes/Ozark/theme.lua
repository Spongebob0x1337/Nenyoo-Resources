...
local THEME_NAME="Ozark"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=false
local HEADER_FILE="Themes\\Ozark\\textures\\header.gif"
local HEADER_PATH="Themes/Ozark/textures/header.gif"
local HEADER_URL_PATH=""
local header_handle=0
local header_downloaded=false
local HEADER_OVERLAY_FILE="Themes\\Ozark\\textures\\header_overlay.bmp"
local HEADER_OVERLAY_PATH="Themes/Ozark/textures/header_overlay.bmp"
local HEADER_OVERLAY_URL_PATH=""
local header_overlay_handle=0
local header_overlay_downloaded=false
local SUBHEADER_FILE="Themes\\Ozark\\textures\\subheader.bmp"
local SUBHEADER_PATH="Themes/Ozark/textures/subheader.bmp"
...
local TOGGLE_ON_FILE="Themes\\Ozark\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Ozark/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Ozark\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Ozark/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Ozark\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Ozark/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["list"]={file="Themes\\Ozark\\textures\\ui_theme_list.png",path="Themes/Ozark/textures/ui_theme_list.png",url=""},
    ["toggle off"]={file="Themes\\Ozark\\textures\\ui_theme_toggle_off.png",path="Themes/Ozark/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off list"]={file="Themes\\Ozark\\textures\\ui_theme_toggle_off_list.png",path="Themes/Ozark/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Ozark\\textures\\ui_theme_toggle_on.png",path="Themes/Ozark/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on list"]={file="Themes\\Ozark\\textures\\ui_theme_toggle_on_list.png",path="Themes/Ozark/textures/ui_theme_toggle_on_list.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_ozark.ini"
menu.clear_settings()
...
menu.add_setting_slider("Stand Position X",215,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",315,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 215)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 315)
        end
    end
end
...
local function serialize_settings()
    ...
    local position_x=setting("Stand Position X") or {f_val=215}
    local position_y=setting("Stand Position Y") or {f_val=315}
    return table.concat({
...
local function reset_settings()
    ...
    menu.set_setting("Stand Position X",215)
    menu.set_setting("Stand Position Y",315)
...
function draw_menu()
    ...
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 215,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 315,0,1080)*hud_sy
