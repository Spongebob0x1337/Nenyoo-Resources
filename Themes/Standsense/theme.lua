...
local THEME_NAME="Standsense"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\Standsense\\textures\\header.png"
local HEADER_PATH="Themes/Standsense/textures/header.png"
...
local TOGGLE_ON_FILE="Themes\\Standsense\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Standsense/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Standsense\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Standsense/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Standsense\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Standsense/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\Standsense\\textures\\ui_theme_disabled.png",path="Themes/Standsense/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\Standsense\\textures\\ui_theme_edit.png",path="Themes/Standsense/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\Standsense\\textures\\ui_theme_enabled.png",path="Themes/Standsense/textures/ui_theme_enabled.png",url=""},
    ["game"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_game.png",path="Themes/Standsense/textures/ui_theme_tabs_game.png",url=""},
    ["link"]={file="Themes\\Standsense\\textures\\ui_theme_link.png",path="Themes/Standsense/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\Standsense\\textures\\ui_theme_list.png",path="Themes/Standsense/textures/ui_theme_list.png",url=""},
    ["online"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_online.png",path="Themes/Standsense/textures/ui_theme_tabs_online.png",url=""},
    ["players"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_players.png",path="Themes/Standsense/textures/ui_theme_tabs_players.png",url=""},
    ["search"]={file="Themes\\Standsense\\textures\\ui_theme_search.png",path="Themes/Standsense/textures/ui_theme_search.png",url=""},
    ["self"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_self.png",path="Themes/Standsense/textures/ui_theme_tabs_self.png",url=""},
    ["stand"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_stand.png",path="Themes/Standsense/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/game"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_game.png",path="Themes/Standsense/textures/ui_theme_tabs_game.png",url=""},
    ["tabs/online"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_online.png",path="Themes/Standsense/textures/ui_theme_tabs_online.png",url=""},
    ["tabs/players"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_players.png",path="Themes/Standsense/textures/ui_theme_tabs_players.png",url=""},
    ["tabs/self"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_self.png",path="Themes/Standsense/textures/ui_theme_tabs_self.png",url=""},
    ["tabs/stand"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_stand.png",path="Themes/Standsense/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/vehicle"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Standsense/textures/ui_theme_tabs_vehicle.png",url=""},
    ["tabs/world"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_world.png",path="Themes/Standsense/textures/ui_theme_tabs_world.png",url=""},
    ["toggle off"]={file="Themes\\Standsense\\textures\\ui_theme_toggle_off.png",path="Themes/Standsense/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off list"]={file="Themes\\Standsense\\textures\\ui_theme_toggle_off_list.png",path="Themes/Standsense/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Standsense\\textures\\ui_theme_toggle_on.png",path="Themes/Standsense/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on list"]={file="Themes\\Standsense\\textures\\ui_theme_toggle_on_list.png",path="Themes/Standsense/textures/ui_theme_toggle_on_list.png",url=""},
    ["vehicle"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Standsense/textures/ui_theme_tabs_vehicle.png",url=""},
    ["world"]={file="Themes\\Standsense\\textures\\ui_theme_tabs_world.png",path="Themes/Standsense/textures/ui_theme_tabs_world.png",url=""},
}
...
local function apply_font_scale(scale)
    ...
    text.set_size(font.title,math.max(1,27*scale))
...
local SETTINGS_FILE="stand_import_v3_standsense.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",19,19,19,255,"Imported primary colour")
menu.add_setting_color("Stand Background",15,15,15,255,"Imported background colour")
menu.add_setting_slider("Stand Width",500,120,1200,1,"Width in Stand's 1920x1080 HUD pixels")
...
menu.add_setting_slider("Stand Position X",1355,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",406,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="width" then menu.set_setting("Stand Width",tonumber(value) or 500)
        ...
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 1355)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 406)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=19,g=19,b=19,a=255}
    local background=setting("Stand Background") or {r=15,g=15,b=15,a=255}
    local width=setting("Stand Width") or {f_val=500}
    local rows=setting("Stand Rows") or {f_val=12}
    local row_height=setting("Stand Row Height") or {f_val=30}
    local position_x=setting("Stand Position X") or {f_val=1355}
    local position_y=setting("Stand Position Y") or {f_val=406}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",19,19,19,255)
    menu.set_setting("Stand Background",15,15,15,255)
    menu.set_setting("Stand Width",500)
    menu.set_setting("Stand Rows",12)
    menu.set_setting("Stand Row Height",30)
    menu.set_setting("Stand Position X",1355)
    menu.set_setting("Stand Position Y",406)
...
function draw_menu()
    ...
    local source_width=clamp(width_setting and width_setting.f_val or 500,120,1200)
    ...
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 1355,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 406,0,1080)*hud_sy
    ...
    local page_h=SUBHEADER_PATH~="" and native_height(subheader_handle,width,46*hud_sy)
        or (TABS_ENABLED and 46*hud_sy or 0)
    ...
    if 255>0 and 3>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,33,33,33,255,5,3)
    end
    ...
    if page_h>0 then
        ...
        if TABS_ENABLED then
            ...
            text.draw(font.small,x+width-10-text.width(font.small,counter),
                page_y+(page_h-text.height(font.small))*0.5,255,255,255,220,counter)
        end
    end
        ...
        if item then
            ...
            if item.is_header then
                text.draw(font.small,x+10,yy+(row_h-text.height(font.small))*0.5,
                    active and 149 or accent.r,active and 184 or accent.g,active and 6 or accent.b,255,
                ...
                text.draw_ellipsis(font.item,text_x,yy+(row_h-text.height(font.item))*0.5,
                    active and 149 or 255,active and 184 or 255,active and 6 or 255,active and 255 or 220,
                ...
                if toggle_type then
                    ...
                    if toggle_handle and toggle_handle>0 then
                        ...
                        draw.rect_outline(indicator_x-5,yy+row_h*0.5-5,indicator_x+5,yy+row_h*0.5+5,
                            active and 149 or 255,active and 184 or 255,active and 6 or 255,210,1,1)
                        if item.on then draw.rect(indicator_x-3,yy+row_h*0.5-3,indicator_x+3,yy+row_h*0.5+3,
                            active and 149 or accent.r,active and 184 or accent.g,active and 6 or accent.b,255,1) end
                    end
                ...
                elseif action_mark then
                    ...
                    if action_handle and action_handle>0 then
                        ...
                        text.draw(font.small,x+width-10-text.width(font.small,mark),yy+(row_h-text.height(font.small))*0.5,
                            active and 149 or 255,active and 184 or 255,active and 6 or 255,255,mark)
                    end
                end
                if value~="" then
                    ...
                    text.draw(font.value,right-text.width(font.value,value),yy+(row_h-text.height(font.value))*0.5,
                        active and 149 or 255,active and 184 or 255,active and 6 or 255,255,value)
                end
            end
    ...
    if footer_handle and footer_handle>0 then
        ...
        text.draw(font.desc,x+9,desc_y+7,255,255,255,220,description,width-18)
        draw.pop_clip()
    end
