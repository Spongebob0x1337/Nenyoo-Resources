...
text.set_font_family("Segoe UI")

local THEME_NAME="Windows98"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\Windows98\\textures\\header.jpeg"
local HEADER_PATH="Themes/Windows98/textures/header.jpeg"
...
local TOGGLE_ON_FILE="Themes\\Windows98\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Windows98/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Windows98\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Windows98/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Windows98\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Windows98/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\Windows98\\textures\\ui_theme_disabled.png",path="Themes/Windows98/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\Windows98\\textures\\ui_theme_edit.png",path="Themes/Windows98/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\Windows98\\textures\\ui_theme_enabled.png",path="Themes/Windows98/textures/ui_theme_enabled.png",url=""},
    ["friends"]={file="Themes\\Windows98\\textures\\ui_theme_friends.png",path="Themes/Windows98/textures/ui_theme_friends.png",url=""},
    ["game"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_game.png",path="Themes/Windows98/textures/ui_theme_tabs_game.png",url=""},
    ["header downloading"]={file="Themes\\Windows98\\textures\\ui_theme_header_downloading.png",path="Themes/Windows98/textures/ui_theme_header_downloading.png",url=""},
    ["header loading"]={file="Themes\\Windows98\\textures\\ui_theme_header_loading.png",path="Themes/Windows98/textures/ui_theme_header_loading.png",url=""},
    ["link"]={file="Themes\\Windows98\\textures\\ui_theme_link.png",path="Themes/Windows98/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\Windows98\\textures\\ui_theme_list.png",path="Themes/Windows98/textures/ui_theme_list.png",url=""},
    ["online"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_online.png",path="Themes/Windows98/textures/ui_theme_tabs_online.png",url=""},
    ["players"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_players.png",path="Themes/Windows98/textures/ui_theme_tabs_players.png",url=""},
    ["search"]={file="Themes\\Windows98\\textures\\ui_theme_search.png",path="Themes/Windows98/textures/ui_theme_search.png",url=""},
    ["self"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_self.png",path="Themes/Windows98/textures/ui_theme_tabs_self.png",url=""},
    ["stand"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_stand.png",path="Themes/Windows98/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/game"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_game.png",path="Themes/Windows98/textures/ui_theme_tabs_game.png",url=""},
    ["tabs/online"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_online.png",path="Themes/Windows98/textures/ui_theme_tabs_online.png",url=""},
    ["tabs/players"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_players.png",path="Themes/Windows98/textures/ui_theme_tabs_players.png",url=""},
    ["tabs/self"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_self.png",path="Themes/Windows98/textures/ui_theme_tabs_self.png",url=""},
    ["tabs/stand"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_stand.png",path="Themes/Windows98/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/vehicle"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Windows98/textures/ui_theme_tabs_vehicle.png",url=""},
    ["tabs/world"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_world.png",path="Themes/Windows98/textures/ui_theme_tabs_world.png",url=""},
    ["toggle off"]={file="Themes\\Windows98\\textures\\ui_theme_toggle_off.png",path="Themes/Windows98/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off auto"]={file="Themes\\Windows98\\textures\\ui_theme_toggle_off_auto.png",path="Themes/Windows98/textures/ui_theme_toggle_off_auto.png",url=""},
    ["toggle off list"]={file="Themes\\Windows98\\textures\\ui_theme_toggle_off_list.png",path="Themes/Windows98/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Windows98\\textures\\ui_theme_toggle_on.png",path="Themes/Windows98/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on auto"]={file="Themes\\Windows98\\textures\\ui_theme_toggle_on_auto.png",path="Themes/Windows98/textures/ui_theme_toggle_on_auto.png",url=""},
    ["toggle on list"]={file="Themes\\Windows98\\textures\\ui_theme_toggle_on_list.png",path="Themes/Windows98/textures/ui_theme_toggle_on_list.png",url=""},
    ["user"]={file="Themes\\Windows98\\textures\\ui_theme_user.png",path="Themes/Windows98/textures/ui_theme_user.png",url=""},
    ["users"]={file="Themes\\Windows98\\textures\\ui_theme_users.png",path="Themes/Windows98/textures/ui_theme_users.png",url=""},
    ["vehicle"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Windows98/textures/ui_theme_tabs_vehicle.png",url=""},
    ["world"]={file="Themes\\Windows98\\textures\\ui_theme_tabs_world.png",path="Themes/Windows98/textures/ui_theme_tabs_world.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_windows98.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",1,0,129,255,"Imported primary colour")
menu.add_setting_color("Stand Background",0,128,128,255,"Imported background colour")
menu.add_setting_slider("Stand Width",437,120,1200,1,"Width in Stand's 1920x1080 HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="width" then menu.set_setting("Stand Width",tonumber(value) or 437)
...
local function serialize_settings()
    local accent=setting("Stand Accent") or {r=1,g=0,b=129,a=255}
    local background=setting("Stand Background") or {r=0,g=128,b=128,a=255}
    local width=setting("Stand Width") or {f_val=437}
...
local function reset_settings()
    menu.set_setting("Stand Accent",1,0,129,255)
    menu.set_setting("Stand Background",0,128,128,255)
    menu.set_setting("Stand Width",437)
...
function draw_menu()
    ...
    local source_width=clamp(width_setting and width_setting.f_val or 437,120,1200)
    ...
    if 255>0 and 4>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,129,129,129,255,0,4)
    end
    ...
    for row=0,visible-1 do
        ...
        if item then
            ...
            if 255>0 then
                draw.rect(x,yy+row_h-1,x+width,yy+row_h,129,129,129,math.min(255,80))
            end
            ...
            if item.is_header then
                ...
                if value~="" then
                    ...
                    text.draw(font.value,right-text.width(font.value,value),yy+(row_h-text.height(font.value))*0.5,
                        active and 255 or 0,active and 255 or 0,active and 255 or 0,255,value)
                end
            end
