...
local NATIVE_CONFIG={
    classic={folder="LS UNDERGROUND",title="LS UNDERGROUND",subtitle="STREET NETWORK",effect="underground",file="ls_underground_theme.ini",accent={190,34,40,255},secondary={245,162,62,255},bg={9,5,6,245}},
...
function draw_menu()
    ...
    if NATIVE_STYLE=="classic" then
        ...
        draw.rect(x,y,x+w,y+h,c.bg[1],c.bg[2],c.bg[3],opacity,2); native_gradient(x,y,w,banner,a,s,t,reduced); native_classic_fx(x,y,w,banner,t,a,s,reduced); text.draw_centered(font.title,x,y+(banner-text.height(font.title))*.42,x+w,255,255,255,255,native.title); text.draw_centered(font.tiny,x,y+banner*.68,x+w,255,255,255,185,native.subtitle or "FREEMODE INTERACTION")
