...
local THEME_NAME="BlackNWhite v2"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\BlackNWhite v2\\textures\\header.png"
local HEADER_PATH="Themes/BlackNWhite v2/textures/header.png"
...
local TOGGLE_ON_FILE="Themes\\BlackNWhite v2\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/BlackNWhite v2/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\BlackNWhite v2\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/BlackNWhite v2/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\BlackNWhite v2\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/BlackNWhite v2/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_disabled.png",path="Themes/BlackNWhite v2/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_edit.png",path="Themes/BlackNWhite v2/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_enabled.png",path="Themes/BlackNWhite v2/textures/ui_theme_enabled.png",url=""},
    ["friends"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_friends.png",path="Themes/BlackNWhite v2/textures/ui_theme_friends.png",url=""},
    ["game"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_game.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_game.png",url=""},
    ["header loading"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_header_loading.png",path="Themes/BlackNWhite v2/textures/ui_theme_header_loading.png",url=""},
    ["link"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_link.png",path="Themes/BlackNWhite v2/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_list.png",path="Themes/BlackNWhite v2/textures/ui_theme_list.png",url=""},
    ["online"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_online.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_online.png",url=""},
    ["players"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_players.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_players.png",url=""},
    ["search"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_search.png",path="Themes/BlackNWhite v2/textures/ui_theme_search.png",url=""},
    ["self"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_self.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_self.png",url=""},
    ["stand"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_stand.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/game"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_game.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_game.png",url=""},
    ["tabs/online"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_online.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_online.png",url=""},
    ["tabs/players"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_players.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_players.png",url=""},
    ["tabs/self"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_self.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_self.png",url=""},
    ["tabs/stand"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_stand.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/vehicle"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_vehicle.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_vehicle.png",url=""},
    ["tabs/world"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_world.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_world.png",url=""},
    ["toggle off"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_toggle_off.png",path="Themes/BlackNWhite v2/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off auto"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_toggle_off_auto.png",path="Themes/BlackNWhite v2/textures/ui_theme_toggle_off_auto.png",url=""},
    ["toggle off list"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_toggle_off_list.png",path="Themes/BlackNWhite v2/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_toggle_on.png",path="Themes/BlackNWhite v2/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on auto"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_toggle_on_auto.png",path="Themes/BlackNWhite v2/textures/ui_theme_toggle_on_auto.png",url=""},
    ["toggle on list"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_toggle_on_list.png",path="Themes/BlackNWhite v2/textures/ui_theme_toggle_on_list.png",url=""},
    ["user"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_user.png",path="Themes/BlackNWhite v2/textures/ui_theme_user.png",url=""},
    ["users"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_users.png",path="Themes/BlackNWhite v2/textures/ui_theme_users.png",url=""},
    ["vehicle"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_vehicle.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_vehicle.png",url=""},
    ["world"]={file="Themes\\BlackNWhite v2\\textures\\ui_theme_tabs_world.png",path="Themes/BlackNWhite v2/textures/ui_theme_tabs_world.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_blacknwhite_v2.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",12,12,12,45,"Imported primary colour")
menu.add_setting_color("Stand Background",0,0,0,100,"Imported background colour")
menu.add_setting_slider("Stand Width",315,120,1200,1,"Width in Stand's 1920x1080 HUD pixels")
menu.add_setting_slider("Stand Rows",20,5,24,1,"Visible option rows")
menu.add_setting_slider("Stand Row Height",25,12,100,1,"Row height in Stand HUD pixels")
menu.add_setting_slider("Stand Position X",1065,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",174,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="width" then menu.set_setting("Stand Width",tonumber(value) or 315)
        elseif key=="rows" then menu.set_setting("Stand Rows",tonumber(value) or 20)
        elseif key=="row_height" then menu.set_setting("Stand Row Height",tonumber(value) or 25)
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 1065)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 174)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=12,g=12,b=12,a=45}
    local background=setting("Stand Background") or {r=0,g=0,b=0,a=100}
    local width=setting("Stand Width") or {f_val=315}
    local rows=setting("Stand Rows") or {f_val=20}
    local row_height=setting("Stand Row Height") or {f_val=25}
    local position_x=setting("Stand Position X") or {f_val=1065}
    local position_y=setting("Stand Position Y") or {f_val=174}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",12,12,12,45)
    menu.set_setting("Stand Background",0,0,0,100)
    menu.set_setting("Stand Width",315)
    menu.set_setting("Stand Rows",20)
    menu.set_setting("Stand Row Height",25)
    menu.set_setting("Stand Position X",1065)
    menu.set_setting("Stand Position Y",174)
...
function draw_menu()
    ...
    local source_width=clamp(width_setting and width_setting.f_val or 315,120,1200)
    ...
    local row_h=clamp(row_height_setting and row_height_setting.f_val or 25,12,100)*hud_sy
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 1065,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 174,0,1080)*hud_sy
    local alpha=background.a or 100
    ...
    if 255>0 and 4>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,255,255,255,255,5,4)
    end
        ...
        if item then
            ...
            if item.is_header then
                text.draw(font.small,x+10,yy+(row_h-text.height(font.small))*0.5,
                    active and 255 or accent.r,active and 245 or accent.g,active and 242 or accent.b,255,
                ...
                text.draw_ellipsis(font.item,text_x,yy+(row_h-text.height(font.item))*0.5,
                    active and 255 or 238,active and 245 or 238,active and 242 or 242,active and 255 or 235,
                ...
                if toggle_type then
                    ...
                    if toggle_handle and toggle_handle>0 then
                        ...
                        draw.rect_outline(indicator_x-5,yy+row_h*0.5-5,indicator_x+5,yy+row_h*0.5+5,
                            active and 255 or 238,active and 245 or 238,active and 242 or 242,210,1,1)
                        if item.on then draw.rect(indicator_x-3,yy+row_h*0.5-3,indicator_x+3,yy+row_h*0.5+3,
                            active and 255 or accent.r,active and 245 or accent.g,active and 242 or accent.b,255,1) end
                    end
                ...
                elseif action_mark then
                    ...
                    if action_handle and action_handle>0 then
                        ...
                        text.draw(font.small,x+width-10-text.width(font.small,mark),yy+(row_h-text.height(font.small))*0.5,
                            active and 255 or 238,active and 245 or 238,active and 242 or 242,255,mark)
                    end
                end
                if value~="" then
                    ...
                    text.draw(font.value,right-text.width(font.value,value),yy+(row_h-text.height(font.value))*0.5,
                        active and 255 or 238,active and 245 or 238,active and 242 or 242,255,value)
                end
            end
