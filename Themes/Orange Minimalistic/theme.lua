...
local THEME_NAME="Orange Minimalistic"
...
local TOGGLE_ON_FILE="Themes\\Orange Minimalistic\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Orange Minimalistic/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Orange Minimalistic\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Orange Minimalistic/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Orange Minimalistic\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Orange Minimalistic/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_disabled.png",path="Themes/Orange Minimalistic/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_edit.png",path="Themes/Orange Minimalistic/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_enabled.png",path="Themes/Orange Minimalistic/textures/ui_theme_enabled.png",url=""},
    ["friends"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_friends.png",path="Themes/Orange Minimalistic/textures/ui_theme_friends.png",url=""},
    ["game"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_game.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_game.png",url=""},
    ["header loading"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_header_loading.png",path="Themes/Orange Minimalistic/textures/ui_theme_header_loading.png",url=""},
    ["link"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_link.png",path="Themes/Orange Minimalistic/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_list.png",path="Themes/Orange Minimalistic/textures/ui_theme_list.png",url=""},
    ["online"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_online.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_online.png",url=""},
    ["players"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_players.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_players.png",url=""},
    ["search"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_search.png",path="Themes/Orange Minimalistic/textures/ui_theme_search.png",url=""},
    ["self"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_self.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_self.png",url=""},
    ["stand"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_stand.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/game"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_game.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_game.png",url=""},
    ["tabs/online"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_online.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_online.png",url=""},
    ["tabs/players"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_players.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_players.png",url=""},
    ["tabs/self"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_self.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_self.png",url=""},
    ["tabs/stand"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_stand.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/vehicle"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_vehicle.png",url=""},
    ["tabs/world"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_world.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_world.png",url=""},
    ["toggle off"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_toggle_off.png",path="Themes/Orange Minimalistic/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off auto"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_toggle_off_auto.png",path="Themes/Orange Minimalistic/textures/ui_theme_toggle_off_auto.png",url=""},
    ["toggle off list"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_toggle_off_list.png",path="Themes/Orange Minimalistic/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_toggle_on.png",path="Themes/Orange Minimalistic/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on auto"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_toggle_on_auto.png",path="Themes/Orange Minimalistic/textures/ui_theme_toggle_on_auto.png",url=""},
    ["toggle on list"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_toggle_on_list.png",path="Themes/Orange Minimalistic/textures/ui_theme_toggle_on_list.png",url=""},
    ["user"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_user.png",path="Themes/Orange Minimalistic/textures/ui_theme_user.png",url=""},
    ["users"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_users.png",path="Themes/Orange Minimalistic/textures/ui_theme_users.png",url=""},
    ["vehicle"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_vehicle.png",url=""},
    ["world"]={file="Themes\\Orange Minimalistic\\textures\\ui_theme_tabs_world.png",path="Themes/Orange Minimalistic/textures/ui_theme_tabs_world.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_orange_minimalistic.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",255,120,58,255,"Imported primary colour")
menu.add_setting_color("Stand Background",17,17,17,255,"Imported background colour")
menu.add_setting_slider("Stand Width",433,120,1200,1,"Width in Stand's 1920x1080 HUD pixels")
...
menu.add_setting_slider("Stand Position X",1402,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",60,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="width" then menu.set_setting("Stand Width",tonumber(value) or 433)
        ...
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 1402)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 60)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=255,g=120,b=58,a=255}
    local background=setting("Stand Background") or {r=17,g=17,b=17,a=255}
    local width=setting("Stand Width") or {f_val=433}
    local rows=setting("Stand Rows") or {f_val=20}
    local row_height=setting("Stand Row Height") or {f_val=25}
    local position_x=setting("Stand Position X") or {f_val=1402}
    local position_y=setting("Stand Position Y") or {f_val=60}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",255,120,58,255)
    menu.set_setting("Stand Background",17,17,17,255)
    menu.set_setting("Stand Width",433)
    menu.set_setting("Stand Rows",20)
    menu.set_setting("Stand Row Height",25)
    menu.set_setting("Stand Position X",1402)
    menu.set_setting("Stand Position Y",60)
...
function draw_menu()
    ...
    local source_width=clamp(width_setting and width_setting.f_val or 433,120,1200)
    ...
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 1402,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 60,0,1080)*hud_sy
    ...
    if 70>0 and 3>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,0,0,0,70,0,3)
    end
    ...
    for row=0,visible-1 do
        ...
        if item then
            ...
            if 70>0 then
                draw.rect(x,yy+row_h-1,x+width,yy+row_h,0,0,0,math.min(70,80))
            end
