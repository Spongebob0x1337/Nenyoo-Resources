...
local THEME_NAME="Rockstar Admin Tools"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\Rockstar Admin Tools\\textures\\header.png"
local HEADER_PATH="Themes/Rockstar Admin Tools/textures/header.png"
...
local UI_ASSETS={
    ["00"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_00.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_00.png",url=""},
    ["01"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_01.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_01.png",url=""},
    ["02"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_02.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_02.png",url=""},
    ["03"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_03.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_03.png",url=""},
    ["04"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_04.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_04.png",url=""},
    ["05"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_05.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_05.png",url=""},
    ["06"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_06.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_06.png",url=""},
    ["07"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_07.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_07.png",url=""},
    ["08"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_08.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_08.png",url=""},
    ["09"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_09.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_09.png",url=""},
    ["0a"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0a.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0a.png",url=""},
    ["0b"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0b.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0b.png",url=""},
    ["0c"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0c.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0c.png",url=""},
    ["0d"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0d.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0d.png",url=""},
    ["0e"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0e.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0e.png",url=""},
    ["0f"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0f.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0f.png",url=""},
    ["10"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_10.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_10.png",url=""},
    ["11"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_11.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_11.png",url=""},
    ["12"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_12.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_12.png",url=""},
    ["13"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_13.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_13.png",url=""},
    ["14"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_14.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_14.png",url=""},
    ["custom/00"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_00.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_00.png",url=""},
    ["custom/01"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_01.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_01.png",url=""},
    ["custom/02"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_02.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_02.png",url=""},
    ["custom/03"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_03.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_03.png",url=""},
    ["custom/04"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_04.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_04.png",url=""},
    ["custom/05"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_05.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_05.png",url=""},
    ["custom/06"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_06.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_06.png",url=""},
    ["custom/07"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_07.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_07.png",url=""},
    ["custom/08"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_08.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_08.png",url=""},
    ["custom/09"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_09.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_09.png",url=""},
    ["custom/0a"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0a.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0a.png",url=""},
    ["custom/0b"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0b.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0b.png",url=""},
    ["custom/0c"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0c.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0c.png",url=""},
    ["custom/0d"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0d.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0d.png",url=""},
    ["custom/0e"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0e.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0e.png",url=""},
    ["custom/0f"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_0f.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_0f.png",url=""},
    ["custom/10"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_10.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_10.png",url=""},
    ["custom/11"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_11.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_11.png",url=""},
    ["custom/12"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_12.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_12.png",url=""},
    ["custom/13"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_13.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_13.png",url=""},
    ["custom/14"]={file="Themes\\Rockstar Admin Tools\\textures\\ui_theme_custom_14.png",path="Themes/Rockstar Admin Tools/textures/ui_theme_custom_14.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_rockstar_admin_tools.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",255,170,0,255,"Imported primary colour")
menu.add_setting_color("Stand Background",0,0,0,120,"Imported background colour")
...
menu.add_setting_slider("Stand Position X",1315,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",241,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 1315)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 241)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=255,g=170,b=0,a=255}
    local background=setting("Stand Background") or {r=0,g=0,b=0,a=120}
    ...
    local position_x=setting("Stand Position X") or {f_val=1315}
    local position_y=setting("Stand Position Y") or {f_val=241}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",255,170,0,255)
    menu.set_setting("Stand Background",0,0,0,120)
    menu.set_setting("Stand Width",380)
    menu.set_setting("Stand Rows",15)
    menu.set_setting("Stand Row Height",35)
    menu.set_setting("Stand Position X",1315)
    menu.set_setting("Stand Position Y",241)
...
function draw_menu()
    ...
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 1315,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 241,0,1080)*hud_sy
    local alpha=background.a or 120
    ...
    if 255>0 and 3>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,255,170,0,255,5,3)
    end
    ...
    for row=0,visible-1 do
        ...
        if item then
            ...
            if 255>0 then
                draw.rect(x,yy+row_h-1,x+width,yy+row_h,255,170,0,math.min(255,80))
            end
