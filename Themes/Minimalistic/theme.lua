...
local THEME_NAME="Minimalistic"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=false
local HEADER_FILE="Themes\\Minimalistic\\textures\\header.png"
local HEADER_PATH="Themes/Minimalistic/textures/header.png"
...
local TOGGLE_ON_FILE="Themes\\Minimalistic\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Minimalistic/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Minimalistic\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Minimalistic/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Minimalistic\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Minimalistic/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\Minimalistic\\textures\\ui_theme_disabled.png",path="Themes/Minimalistic/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\Minimalistic\\textures\\ui_theme_edit.png",path="Themes/Minimalistic/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\Minimalistic\\textures\\ui_theme_enabled.png",path="Themes/Minimalistic/textures/ui_theme_enabled.png",url=""},
    ["friends"]={file="Themes\\Minimalistic\\textures\\ui_theme_friends.png",path="Themes/Minimalistic/textures/ui_theme_friends.png",url=""},
    ["link"]={file="Themes\\Minimalistic\\textures\\ui_theme_link.png",path="Themes/Minimalistic/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\Minimalistic\\textures\\ui_theme_list.png",path="Themes/Minimalistic/textures/ui_theme_list.png",url=""},
    ["search"]={file="Themes\\Minimalistic\\textures\\ui_theme_search.png",path="Themes/Minimalistic/textures/ui_theme_search.png",url=""},
    ["toggle off"]={file="Themes\\Minimalistic\\textures\\ui_theme_toggle_off.png",path="Themes/Minimalistic/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off auto"]={file="Themes\\Minimalistic\\textures\\ui_theme_toggle_off_auto.png",path="Themes/Minimalistic/textures/ui_theme_toggle_off_auto.png",url=""},
    ["toggle on"]={file="Themes\\Minimalistic\\textures\\ui_theme_toggle_on.png",path="Themes/Minimalistic/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on auto"]={file="Themes\\Minimalistic\\textures\\ui_theme_toggle_on_auto.png",path="Themes/Minimalistic/textures/ui_theme_toggle_on_auto.png",url=""},
    ["user"]={file="Themes\\Minimalistic\\textures\\ui_theme_user.png",path="Themes/Minimalistic/textures/ui_theme_user.png",url=""},
    ["users"]={file="Themes\\Minimalistic\\textures\\ui_theme_users.png",path="Themes/Minimalistic/textures/ui_theme_users.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_minimalistic.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",15,15,15,150,"Imported primary colour")
...
local function serialize_settings()
    local accent=setting("Stand Accent") or {r=15,g=15,b=15,a=150}
...
local function reset_settings()
    menu.set_setting("Stand Accent",15,15,15,150)
