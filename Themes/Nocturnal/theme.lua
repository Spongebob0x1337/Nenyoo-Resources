...
local THEME_NAME="Nocturnal"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\Nocturnal\\textures\\header.png"
local HEADER_PATH="Themes/Nocturnal/textures/header.png"
...
local TOGGLE_ON_FILE="Themes\\Nocturnal\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Nocturnal/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Nocturnal\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Nocturnal/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Nocturnal\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Nocturnal/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\Nocturnal\\textures\\ui_theme_disabled.png",path="Themes/Nocturnal/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\Nocturnal\\textures\\ui_theme_edit.png",path="Themes/Nocturnal/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\Nocturnal\\textures\\ui_theme_enabled.png",path="Themes/Nocturnal/textures/ui_theme_enabled.png",url=""},
    ["friends"]={file="Themes\\Nocturnal\\textures\\ui_theme_friends.png",path="Themes/Nocturnal/textures/ui_theme_friends.png",url=""},
    ["game"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_game.png",path="Themes/Nocturnal/textures/ui_theme_tabs_game.png",url=""},
    ["link"]={file="Themes\\Nocturnal\\textures\\ui_theme_link.png",path="Themes/Nocturnal/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\Nocturnal\\textures\\ui_theme_list.png",path="Themes/Nocturnal/textures/ui_theme_list.png",url=""},
    ["online"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_online.png",path="Themes/Nocturnal/textures/ui_theme_tabs_online.png",url=""},
    ["players"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_players.png",path="Themes/Nocturnal/textures/ui_theme_tabs_players.png",url=""},
    ["search"]={file="Themes\\Nocturnal\\textures\\ui_theme_search.png",path="Themes/Nocturnal/textures/ui_theme_search.png",url=""},
    ["search_"]={file="Themes\\Nocturnal\\textures\\ui_theme_search.png",path="Themes/Nocturnal/textures/ui_theme_search.png",url=""},
    ["self"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_self.png",path="Themes/Nocturnal/textures/ui_theme_tabs_self.png",url=""},
    ["stand"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_stand.png",path="Themes/Nocturnal/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/game"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_game.png",path="Themes/Nocturnal/textures/ui_theme_tabs_game.png",url=""},
    ["tabs/online"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_online.png",path="Themes/Nocturnal/textures/ui_theme_tabs_online.png",url=""},
    ["tabs/players"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_players.png",path="Themes/Nocturnal/textures/ui_theme_tabs_players.png",url=""},
    ["tabs/self"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_self.png",path="Themes/Nocturnal/textures/ui_theme_tabs_self.png",url=""},
    ["tabs/stand"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_stand.png",path="Themes/Nocturnal/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/vehicle"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Nocturnal/textures/ui_theme_tabs_vehicle.png",url=""},
    ["tabs/world"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_world.png",path="Themes/Nocturnal/textures/ui_theme_tabs_world.png",url=""},
    ["toggle off"]={file="Themes\\Nocturnal\\textures\\ui_theme_toggle_off.png",path="Themes/Nocturnal/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off auto"]={file="Themes\\Nocturnal\\textures\\ui_theme_toggle_off_auto.png",path="Themes/Nocturnal/textures/ui_theme_toggle_off_auto.png",url=""},
    ["toggle off list"]={file="Themes\\Nocturnal\\textures\\ui_theme_toggle_off_list.png",path="Themes/Nocturnal/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Nocturnal\\textures\\ui_theme_toggle_on.png",path="Themes/Nocturnal/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on auto"]={file="Themes\\Nocturnal\\textures\\ui_theme_toggle_on_auto.png",path="Themes/Nocturnal/textures/ui_theme_toggle_on_auto.png",url=""},
    ["toggle on list"]={file="Themes\\Nocturnal\\textures\\ui_theme_toggle_on_list.png",path="Themes/Nocturnal/textures/ui_theme_toggle_on_list.png",url=""},
    ["user"]={file="Themes\\Nocturnal\\textures\\ui_theme_user.png",path="Themes/Nocturnal/textures/ui_theme_user.png",url=""},
    ["users"]={file="Themes\\Nocturnal\\textures\\ui_theme_users.png",path="Themes/Nocturnal/textures/ui_theme_users.png",url=""},
    ["vehicle"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Nocturnal/textures/ui_theme_tabs_vehicle.png",url=""},
    ["world"]={file="Themes\\Nocturnal\\textures\\ui_theme_tabs_world.png",path="Themes/Nocturnal/textures/ui_theme_tabs_world.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_nocturnal.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",16,21,26,255,"Imported primary colour")
menu.add_setting_color("Stand Background",18,23,29,245,"Imported background colour")
...
menu.add_setting_slider("Stand Position X",1460,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",666,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 1460)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 666)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=16,g=21,b=26,a=255}
    local background=setting("Stand Background") or {r=18,g=23,b=29,a=245}
    ...
    local position_x=setting("Stand Position X") or {f_val=1460}
    local position_y=setting("Stand Position Y") or {f_val=666}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",16,21,26,255)
    menu.set_setting("Stand Background",18,23,29,245)
    menu.set_setting("Stand Width",448)
    menu.set_setting("Stand Rows",12)
    menu.set_setting("Stand Row Height",31)
    menu.set_setting("Stand Position X",1460)
    menu.set_setting("Stand Position Y",666)
...
function draw_menu()
    ...
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 1460,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 666,0,1080)*hud_sy
    local alpha=background.a or 245
    ...
    if 255>0 and 1>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,16,21,26,255,0,1)
    end
    ...
    if page_h>0 then
        ...
        if TABS_ENABLED then
            ...
            text.draw(font.small,x+width-10-text.width(font.small,counter),
                page_y+(page_h-text.height(font.small))*0.5,111,115,122,255,counter)
        end
    end
    ...
    for row=0,visible-1 do
        ...
        if item then
            ...
            if 255>0 then
                draw.rect(x,yy+row_h-1,x+width,yy+row_h,16,21,26,math.min(255,80))
            end
            ...
            if item.is_header then
                ...
                text.draw_ellipsis(font.item,text_x,yy+(row_h-text.height(font.item))*0.5,
                    active and 255 or 111,active and 255 or 115,active and 255 or 122,active and 255 or 255,
                ...
                if toggle_type then
                    ...
                    if toggle_handle and toggle_handle>0 then
                        ...
                        draw.rect_outline(indicator_x-5,yy+row_h*0.5-5,indicator_x+5,yy+row_h*0.5+5,
                            active and 255 or 111,active and 255 or 115,active and 255 or 122,210,1,1)
                ...
                elseif action_mark then
                    ...
                    if action_handle and action_handle>0 then
                        ...
                        text.draw(font.small,x+width-10-text.width(font.small,mark),yy+(row_h-text.height(font.small))*0.5,
                            active and 255 or 111,active and 255 or 115,active and 255 or 122,255,mark)
                    end
                end
                if value~="" then
                    ...
                    text.draw(font.value,right-text.width(font.value,value),yy+(row_h-text.height(font.value))*0.5,
                        active and 255 or 111,active and 255 or 115,active and 255 or 122,255,value)
                end
            end
    ...
    if footer_handle and footer_handle>0 then
        ...
        text.draw(font.desc,x+9,desc_y+7,111,115,122,255,description,width-18)
        draw.pop_clip()
    end
