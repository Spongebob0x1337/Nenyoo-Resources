...
$target = Join-Path $env:LOCALAPPDATA 'Nenyoo\Plus\Themes\Cherax'
...
Write-Host 'Installed Cherax/theme.' -ForegroundColor Magenta
Write-Host 'Open Nenyoo Theme Settings and load Cherax/theme.'
