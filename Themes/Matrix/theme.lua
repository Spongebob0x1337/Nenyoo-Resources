...
local THEME_NAME="Matrix"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\Matrix\\textures\\header.gif"
local HEADER_PATH="Themes/Matrix/textures/header.gif"
...
local TOGGLE_ON_FILE="Themes\\Matrix\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Matrix/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Matrix\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Matrix/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Matrix\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Matrix/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["disabled"]={file="Themes\\Matrix\\textures\\ui_theme_disabled.png",path="Themes/Matrix/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\Matrix\\textures\\ui_theme_edit.png",path="Themes/Matrix/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\Matrix\\textures\\ui_theme_enabled.png",path="Themes/Matrix/textures/ui_theme_enabled.png",url=""},
    ["friends"]={file="Themes\\Matrix\\textures\\ui_theme_friends.png",path="Themes/Matrix/textures/ui_theme_friends.png",url=""},
    ["link"]={file="Themes\\Matrix\\textures\\ui_theme_link.png",path="Themes/Matrix/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\Matrix\\textures\\ui_theme_list.png",path="Themes/Matrix/textures/ui_theme_list.png",url=""},
    ["search"]={file="Themes\\Matrix\\textures\\ui_theme_search.png",path="Themes/Matrix/textures/ui_theme_search.png",url=""},
    ["toggle off"]={file="Themes\\Matrix\\textures\\ui_theme_toggle_off.png",path="Themes/Matrix/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off auto"]={file="Themes\\Matrix\\textures\\ui_theme_toggle_off_auto.png",path="Themes/Matrix/textures/ui_theme_toggle_off_auto.png",url=""},
    ["toggle off list"]={file="Themes\\Matrix\\textures\\ui_theme_toggle_off_list.png",path="Themes/Matrix/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\Matrix\\textures\\ui_theme_toggle_on.png",path="Themes/Matrix/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on auto"]={file="Themes\\Matrix\\textures\\ui_theme_toggle_on_auto.png",path="Themes/Matrix/textures/ui_theme_toggle_on_auto.png",url=""},
    ["toggle on list"]={file="Themes\\Matrix\\textures\\ui_theme_toggle_on_list.png",path="Themes/Matrix/textures/ui_theme_toggle_on_list.png",url=""},
    ["user"]={file="Themes\\Matrix\\textures\\ui_theme_user.png",path="Themes/Matrix/textures/ui_theme_user.png",url=""},
    ["users"]={file="Themes\\Matrix\\textures\\ui_theme_users.png",path="Themes/Matrix/textures/ui_theme_users.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_matrix.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",0,0,0,255,"Imported primary colour")
menu.add_setting_color("Stand Background",0,0,0,211,"Imported background colour")
menu.add_setting_slider("Stand Width",469,120,1200,1,"Width in Stand's 1920x1080 HUD pixels")
menu.add_setting_slider("Stand Rows",13,5,24,1,"Visible option rows")
menu.add_setting_slider("Stand Row Height",41,12,100,1,"Row height in Stand HUD pixels")
menu.add_setting_slider("Stand Position X",30,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",148,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="width" then menu.set_setting("Stand Width",tonumber(value) or 469)
        elseif key=="rows" then menu.set_setting("Stand Rows",tonumber(value) or 13)
        elseif key=="row_height" then menu.set_setting("Stand Row Height",tonumber(value) or 41)
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 30)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 148)
        end
    end
end
...
local function serialize_settings()
    ...
    local background=setting("Stand Background") or {r=0,g=0,b=0,a=211}
    local width=setting("Stand Width") or {f_val=469}
    local rows=setting("Stand Rows") or {f_val=13}
    local row_height=setting("Stand Row Height") or {f_val=41}
    local position_x=setting("Stand Position X") or {f_val=30}
    local position_y=setting("Stand Position Y") or {f_val=148}
    return table.concat({
...
local function reset_settings()
    ...
    menu.set_setting("Stand Background",0,0,0,211)
    menu.set_setting("Stand Width",469)
    menu.set_setting("Stand Rows",13)
    menu.set_setting("Stand Row Height",41)
    menu.set_setting("Stand Position X",30)
    menu.set_setting("Stand Position Y",148)
...
function draw_menu()
    ...
    local source_width=clamp(width_setting and width_setting.f_val or 469,120,1200)
    ...
    local row_h=clamp(row_height_setting and row_height_setting.f_val or 41,12,100)*hud_sy
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 30,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 148,0,1080)*hud_sy
    local alpha=background.a or 211
    ...
    if 255>0 and 1>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,0,100,0,255,0,1)
    end
    ...
    for row=0,visible-1 do
        ...
        if item then
            ...
            if 255>0 then
                draw.rect(x,yy+row_h-1,x+width,yy+row_h,0,100,0,math.min(255,80))
            end
            ...
            if item.is_header then
                ...
                if value~="" then
                    ...
                    text.draw(font.value,right-text.width(font.value,value),yy+(row_h-text.height(font.value))*0.5,
                        active and 255 or 0,active and 255 or 255,active and 255 or 0,255,value)
                end
            end
    ...
    if footer_handle and footer_handle>0 then
        ...
        text.draw(font.desc,x+9,desc_y+7,0,255,0,255,description,width-18)
        draw.pop_clip()
    end
