...
local SETTINGS_FILE="stand_import_v3_paragone.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",30,103,147,255,"Imported primary colour")
...
local function serialize_settings()
    local accent=setting("Stand Accent") or {r=30,g=103,b=147,a=255}
...
local function reset_settings()
    menu.set_setting("Stand Accent",30,103,147,255)
