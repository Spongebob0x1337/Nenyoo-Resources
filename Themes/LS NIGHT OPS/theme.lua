...
local NATIVE_CONFIG={
    classic={folder="LS NIGHT OPS",title="LS NIGHT OPS",subtitle="TACTICAL OPERATIONS",effect="ops",file="ls_night_ops_theme.ini",accent={56,158,92,255},secondary={237,178,70,255},bg={4,9,7,245},banner=true,banner_h=120},
