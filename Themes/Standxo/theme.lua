...
local THEME_NAME="Standxo"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=true
local HEADER_FILE="Themes\\Standxo\\textures\\header.png"
local HEADER_PATH="Themes/Standxo/textures/header.png"
...
local TOGGLE_ON_FILE="Themes\\Standxo\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/Standxo/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\Standxo\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/Standxo/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\Standxo\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/Standxo/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["00"]={file="Themes\\Standxo\\textures\\ui_theme_custom_00.png",path="Themes/Standxo/textures/ui_theme_custom_00.png",url=""},
    ["custom/00"]={file="Themes\\Standxo\\textures\\ui_theme_custom_00.png",path="Themes/Standxo/textures/ui_theme_custom_00.png",url=""},
    ["disabled"]={file="Themes\\Standxo\\textures\\ui_theme_disabled.png",path="Themes/Standxo/textures/ui_theme_disabled.png",url=""},
    ["edit"]={file="Themes\\Standxo\\textures\\ui_theme_edit.png",path="Themes/Standxo/textures/ui_theme_edit.png",url=""},
    ["enabled"]={file="Themes\\Standxo\\textures\\ui_theme_enabled.png",path="Themes/Standxo/textures/ui_theme_enabled.png",url=""},
    ["game"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_game.png",path="Themes/Standxo/textures/ui_theme_tabs_game.png",url=""},
    ["link"]={file="Themes\\Standxo\\textures\\ui_theme_link.png",path="Themes/Standxo/textures/ui_theme_link.png",url=""},
    ["list"]={file="Themes\\Standxo\\textures\\ui_theme_list.png",path="Themes/Standxo/textures/ui_theme_list.png",url=""},
    ["online"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_online.png",path="Themes/Standxo/textures/ui_theme_tabs_online.png",url=""},
    ["players"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_players.png",path="Themes/Standxo/textures/ui_theme_tabs_players.png",url=""},
    ["search"]={file="Themes\\Standxo\\textures\\ui_theme_search.png",path="Themes/Standxo/textures/ui_theme_search.png",url=""},
    ["self"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_self.png",path="Themes/Standxo/textures/ui_theme_tabs_self.png",url=""},
    ["stand"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_stand.png",path="Themes/Standxo/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/game"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_game.png",path="Themes/Standxo/textures/ui_theme_tabs_game.png",url=""},
    ["tabs/online"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_online.png",path="Themes/Standxo/textures/ui_theme_tabs_online.png",url=""},
    ["tabs/players"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_players.png",path="Themes/Standxo/textures/ui_theme_tabs_players.png",url=""},
    ["tabs/self"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_self.png",path="Themes/Standxo/textures/ui_theme_tabs_self.png",url=""},
    ["tabs/stand"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_stand.png",path="Themes/Standxo/textures/ui_theme_tabs_stand.png",url=""},
    ["tabs/vehicle"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Standxo/textures/ui_theme_tabs_vehicle.png",url=""},
    ["tabs/world"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_world.png",path="Themes/Standxo/textures/ui_theme_tabs_world.png",url=""},
    ["toggle off"]={file="Themes\\Standxo\\textures\\ui_theme_toggle_off.png",path="Themes/Standxo/textures/ui_theme_toggle_off.png",url=""},
    ["toggle on"]={file="Themes\\Standxo\\textures\\ui_theme_toggle_on.png",path="Themes/Standxo/textures/ui_theme_toggle_on.png",url=""},
    ["vehicle"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_vehicle.png",path="Themes/Standxo/textures/ui_theme_tabs_vehicle.png",url=""},
    ["world"]={file="Themes\\Standxo\\textures\\ui_theme_tabs_world.png",path="Themes/Standxo/textures/ui_theme_tabs_world.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_standxo.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",40,40,40,200,"Imported primary colour")
...
menu.add_setting_slider("Stand Position X",1412,0,1920,1,"Main-list X coordinate in Stand HUD pixels")
menu.add_setting_slider("Stand Position Y",570,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="position_x" then menu.set_setting("Stand Position X",tonumber(value) or 1412)
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 570)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=40,g=40,b=40,a=200}
    ...
    local position_x=setting("Stand Position X") or {f_val=1412}
    local position_y=setting("Stand Position Y") or {f_val=570}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",40,40,40,200)
    ...
    menu.set_setting("Stand Position X",1412)
    menu.set_setting("Stand Position Y",570)
...
function draw_menu()
    ...
    local position_x=clamp(position_x_setting and position_x_setting.f_val or 1412,0,1920)*hud_sx
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 570,0,1080)*hud_sy
    ...
    if 200>0 and 4>0 then
        draw.rect_outline(x,content_y,x+width,content_y+body_h,0,0,0,200,5,4)
    end
    ...
    for row=0,visible-1 do
        ...
        if item then
            ...
            if 200>0 then
                draw.rect(x,yy+row_h-1,x+width,yy+row_h,0,0,0,math.min(200,80))
            end
