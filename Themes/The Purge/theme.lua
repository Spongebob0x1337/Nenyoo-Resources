...
local THEME_NAME="The Purge"
local LAYOUT_MODE="standard"
local TAB_BOTTOM=false
local TABS_ENABLED=false
local HEADER_FILE="Themes\\The Purge\\textures\\header.bmp"
local HEADER_PATH="Themes/The Purge/textures/header.bmp"
...
local TOGGLE_ON_FILE="Themes\\The Purge\\textures\\toggle_on.png"
local TOGGLE_ON_PATH="Themes/The Purge/textures/toggle_on.png"
local TOGGLE_ON_URL_PATH=""
local toggle_on_handle=0
local toggle_on_downloaded=false
local TOGGLE_OFF_FILE="Themes\\The Purge\\textures\\toggle_off.png"
local TOGGLE_OFF_PATH="Themes/The Purge/textures/toggle_off.png"
local TOGGLE_OFF_URL_PATH=""
local toggle_off_handle=0
local toggle_off_downloaded=false
local LIST_ICON_FILE="Themes\\The Purge\\textures\\list_icon.png"
local LIST_ICON_PATH="Themes/The Purge/textures/list_icon.png"
local LIST_ICON_URL_PATH=""
local list_icon_handle=0
local list_icon_downloaded=false
local UI_ASSETS={
    ["list"]={file="Themes\\The Purge\\textures\\ui_theme_list.png",path="Themes/The Purge/textures/ui_theme_list.png",url=""},
    ["toggle off"]={file="Themes\\The Purge\\textures\\ui_theme_toggle_off.png",path="Themes/The Purge/textures/ui_theme_toggle_off.png",url=""},
    ["toggle off list"]={file="Themes\\The Purge\\textures\\ui_theme_toggle_off_list.png",path="Themes/The Purge/textures/ui_theme_toggle_off_list.png",url=""},
    ["toggle on"]={file="Themes\\The Purge\\textures\\ui_theme_toggle_on.png",path="Themes/The Purge/textures/ui_theme_toggle_on.png",url=""},
    ["toggle on list"]={file="Themes\\The Purge\\textures\\ui_theme_toggle_on_list.png",path="Themes/The Purge/textures/ui_theme_toggle_on_list.png",url=""},
}
...
local SETTINGS_FILE="stand_import_v3_the_purge.ini"
menu.clear_settings()
menu.add_setting_color("Stand Accent",255,0,0,255,"Imported primary colour")
menu.add_setting_color("Stand Background",28,28,28,255,"Imported background colour")
...
menu.add_setting_slider("Stand Position Y",335,0,1080,1,"Main-list Y coordinate in Stand HUD pixels")
...
local function load_settings()
    ...
    for line in body:gmatch("[^\r\n]+") do
        ...
        elseif key=="position_y" then menu.set_setting("Stand Position Y",tonumber(value) or 335)
        end
    end
end

local function serialize_settings()
    local accent=setting("Stand Accent") or {r=255,g=0,b=0,a=255}
    local background=setting("Stand Background") or {r=28,g=28,b=28,a=255}
    ...
    local position_y=setting("Stand Position Y") or {f_val=335}
    return table.concat({
...
local function reset_settings()
    menu.set_setting("Stand Accent",255,0,0,255)
    menu.set_setting("Stand Background",28,28,28,255)
    ...
    menu.set_setting("Stand Position Y",335)
...
function draw_menu()
    ...
    local position_y=clamp(position_y_setting and position_y_setting.f_val or 335,0,1080)*hud_sy
